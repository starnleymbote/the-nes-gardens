                ...
                <div class="col-lg-8">
                    <div class="contact-content">
                        ...
                        <form id="contactform" method="post"
                            action="https://themesflat.co/html/homzen/contact/contact-process.php" class="form-contact">
                            <div class="box grid-2">
                                ...
                                <fieldset>
                                    ...
                                    <input type="text" class="form-control style-1" placeholder="Email" name="email"
                                        id="email" required>
                                </fieldset>
                            </div>
                            <div class="box grid-2">
                    ...
                    <div class="contact-info">
                        ...
                        <ul>
                            ...
                            <li class="box">
                                ...
                                <p class="p-16 text-variant-1">Monay - Friday: 08:00 - 20:00 <br> Saturday - Sunday: 10:00 -
                                    18:00</p>
