                ...
                <div class="col-lg-12">
                    <div class="slider-content">
                        <div class="heading text-center">
                            ...
                            <p class="subtitle text-white body-1 wow fadeIn" data-wow-delay=".8s"
                                data-wow-duration="2000ms">We are a real estate agency that will help you find the best
                                residence you dream of, let’s discuss for your dream house?</p>
                        </div>
                                            ...
                                            <div class="wd-find-select">
                                                <div class="inner-group">
                                                    ...
                                                    <div class="form-group-2 form-style">
                                                        ...
                                                        <div class="group-ip">
                                                            <input type="text" class="form-control"
                                                                placeholder="Search Location" value="" name="s"
                                                                title="Search for" required="">
                                                    ...
                                                    <div class="group-amenities mt-8 grid-6">
                                                        <div class="box-amenities">
                                                            ...
                                                            <fieldset class="amenities-item mt-12">
                                                                <input type="checkbox" class="tf-checkbox style-1"
                                                                    id="cb2">
                                                                <label for="cb2" class="text-cb-amenities">Cable
                                                                    TV</label>
                                                            </fieldset>
                                                            <fieldset class="amenities-item mt-12">
                                                                <input type="checkbox" class="tf-checkbox style-1"
        ...
        <div class="container">
            ...
            <div class="flat-tab-recommended wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
                <ul class="nav-tab-recommended justify-content-center" role="tablist">
                    <x-home.tab href="#viewAll">View All</x-home.tab>
                    <x-home.tab href="#apartment">Apartment</x-home.tab>
                    <x-home.tab href="#villa">Villa</x-home.tab>
                    <x-home.tab href="#studio">Studio</x-home.tab>
                    <x-home.tab href="#house">House</x-home.tab>
                    <x-home.tab href="#office">Office</x-home.tab>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade" id="viewAll" role="tabpanel">
                        <div class="row">
                            ...
                            {{-- <x-home-card.listing isFeatured = "Featured" type = "For Sale" listType = "Studio"
                                ...
                                location ="72 Sunset Avenue, Los Angeles, California" listType = "Apartment"
                                numberOfBeds =  "3" numberOfBathRooms = "2" size = "750"></x-home-card.listing> --}}
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="homeya-box">
                                    <div class="archive-top">
                                        ...
                                        <div class="content">
                                            <div class="h7 text-capitalize fw-7"><a href="property-details-v2.html"
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="homeya-box">
                                    <div class="archive-top">
                                        ...
                                        <div class="content">
                                            <div class="h7 text-capitalize fw-7"><a href="property-details-v3.html"
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="homeya-box">
                                    <div class="archive-top">
                                        ...
                                        <div class="content">
                                            <div class="h7 text-capitalize fw-7"><a href="property-details-v4.html"
