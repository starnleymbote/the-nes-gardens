...
<head>
    ...
    <link rel="stylesheet" href="css/apexcharts.html">
...
<body class="body bg-surface counter-scroll">
            ...
            <div class="layout-wrap">
                                ...
                                <div class="inner-container d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="logo-box d-flex">
                                        <div class="logo"><a href="index-2.html"><img src="images/logo/new_logo.png"
                                                    alt="logo" width="174" height="44"></a></div>
                                            ...
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2"><a href="#">Properties</a>
                                                        <ul>
                                                            <li><a href="property-details-v1.html">Property Details
                                                                    1</a></li>
                                                            <li><a href="property-details-v2.html">Property Details
                                                                    2</a></li>
                                                            <li><a href="property-details-v3.html">Property Details
                                                                    3</a></li>
                                                            <li><a href="property-details-v4.html">Property Details
                                                                    4</a></li>
                                                        </ul>
                                                    </li>
                ...
                <div class="sidebar-menu-dashboard">
                    <ul class="box-menu-dashboard">
                        ...
                        <li class="nav-menu-item"><a class="nav-menu-link" href="reviews.html"><span
                        ...
                        <li class="nav-menu-item"><a class="nav-menu-link" href="add-property.html">
                                ...
                                Add Property</a></li>
                        <li class="nav-menu-item"><a class="nav-menu-link" href="index-2.html"><span
    ...
    <!-- <script type="text/javascript" src="js/dashboard-menu.min.js"></script>
