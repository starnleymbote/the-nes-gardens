                     ...
                     <div class="footer-cl-1">
                         ...
                         <ul class="mt-12">
                             ...
                             <li class="mt-12 d-flex align-items-center gap-8">
                                ...
                                <p class="text-white">
                                    <a href="mailto:info@nesgardens.com" class="text-white caption-1">info@nesgardens.com</a>
                                    <a href="mailto:sales@nesgardens.com" class="text-white caption-1">sales@nesgardens.com</a> 
                                </p>
                            </li>
                         </ul>
     ...
     <div class="bottom-footer">
         <div class="container">
             <div class="content-footer-bottom">
                 <div class="copyright">©2024 Nes Gardens. All Rights Reserved.</div>
         ...
         <div class="modal-content">
             <div class="flat-account bg-surface">
                 ...
                 <form action="#">
                     ...
                     <div class="mt-12 text-variant-1 text-center noti">Not registered yet?<a href="#modalRegister"
                             data-bs-toggle="modal" class="text-black fw-5">Sign Up</a> </div>
                 </form>
             </div>
         </div>
     </div>
         ...
         <div class="modal-content">
             <div class="flat-account bg-surface">
                 ...
                 <form action="#">
                     ...
                     <fieldset class="d-flex align-items-center gap-6">
                         <input type="checkbox" class="tf-checkbox style-2" id="cb1">
                         <label for="cb1" class="caption-1 text-variant-1">I agree to the <span
                                 class="fw-5 text-black">Terms of User</span></label>
                     </fieldset>

                     <button type="submit" class="tf-btn primary w-100">Register</button>
                     <div class="mt-12 text-variant-1 text-center noti">Already have an account?<a href="#modalLogin"
                             data-bs-toggle="modal" class="text-black fw-5">Login Here</a> </div>
                 </form>
             </div>
         </div>
     </div>
